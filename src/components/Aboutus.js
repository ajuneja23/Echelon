...
const Aboutus=()=>{
    return (
        <div>
            ...
            <div id="row11" class="flex relative content-center items-center mx-2 mt-2 mb-2">
            <div id="aadit" class=" w-7/12 h-3/6 mr-1">
                <Card variant="outlined" sx={{border:1, width: 1}}>
                    ...
                    <Typography class="text-sm font-sans">
                        ...
                        Aadit is a junior at Adlai E. Stevenson High School. He started his involvement in history competitions when he was in 7th grader, and avidly participates at local and national competitions. Outside of history, Aadit enjoys baking, mathematics, and listening to music.
                    </Typography>
                    </div>
                </Card>
            </div>
            <br></br>
            <div id="vishal" class=" w-7/12 mr-1 h-3/6">
                <Card variant="outlined" sx={{border:1, width: 1}}>
                    ...
                    <Typography class="text-sm font-sans mr-1">
                        ...
                        Vishal is a junior at James Clemens High School. Vishal has been a historical scholar since he was in elementary school, taking college level history classes at his local university in the 5th grade. Outside of history, Vishal likes composing music, cooking, and dancing.
                    </Typography>
                    </div>
                </Card>
            </div>
            <div id="simon" class=" w-7/12 h-3/6">
            <Card variant="outlined" sx={{border:1, width: 1}}>
                    ...
                    <Typography class="text-sm font-sans mr-1">
                        ...
                        Simon is a junior at East Brunswick High School. Simon has participated in history tournaments since 7th grade, placing high regionally and nationally. Aside from history competitions, Simon enjoys swimming, watching many sports, and listening to rap music.
                    </Typography>
                    </div>
                </Card>
            </div>
            </div>
            <div id="row22" class="flex relative content-center items-center mx-2 mt-2 mb-2">
            <div id="steven" class="w-7/12 h-3/6 mr-1">
                <Card variant="outlined" sx={{border:1, width: 1}}>
                    ...
                    <Typography class="text-sm font-sans">
                        ...
                        Steven is currently a sophomore at Morgantown High School. Though relatively new to history tournaments, he eagerly competes in tournaments at both local and national levels. When not focusing on history, Steven likes reading comics and playing TF2.
                    </Typography>
                    </div>
                </Card>
            </div>
            <br></br>
            <div id="daniel" class="w-7/12 h-3/6 mr-1">
                <Card variant="outlined" sx={{border:1, width: 1}}>
                    ...
                    <Typography class="text-sm font-sans mr-1">
                        ...
                        Daniel is a sophomore at Ransom Everglades School. Daniel has participated in history tournaments since 6th grade, regularly placing highly at regionals and nationals. Outside of learning history, Daniel enjoys listening to music, mountain biking, and cinema.
                    </Typography>
                    </div>
                </Card>
            </div>
            <div id="nate" class="w-7/12 h-3/6">
            <Card variant="outlined" sx={{border:1, width: 1}}>
                    ...
                    <Typography class="text-sm font-sans mr-1">
                        ...
                        Nathaniel is a senior at St. Margaret's Episcopal School in California. Nathaniel has participated in history tournaments since 5th grade, and often wins  SoCal regional history tournaments. Outside of history competitions, Nate enjoys all things music.
